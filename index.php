    ...
    <div class="home-page">
        ...
        <div class="introduction">
            ...
            <div class="intro-content">
                ...
                <span>Foale Trading</span><span class="number"></span>
                <p class="slogan-text text-capitalize">.</p>

                <div class="social-media hidden-xs">
                  <a href="https://twitter.com/TheNextMoveIs" class="fa fa-twitter" data-toggle="tooltip" title="Twitter"></a>
                 <a href="https://www.linkedin.com/in/davidfoale" class="fa fa-linkedin" data-toggle="tooltip" title="Linkedin"></a>
                                   
                </div>
 <!-- <a href="https://www.linkedin.com/in/davidfoale"> <img src="assets/img/linkedin.png" alt="HTML tutorial" style="width:10px;height:10px;border:0;">  </a> -->

            </div>
              <img src="assets/img/tradinglogo.jpg" style="width:10px;height:10px;border:0;">
    ...
    <div id="about_us" class="profile-page container-fluid page">
        <div class="row">
            ...
            <div class="content-container col-md-9 col-sm-12">
                ...
                <div class="clearfix">
                    <h2 class="small-heading">LEARN ABOUT ME</h2>
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-1 col-xs-10 col-xs-offset-1">
                            <div class="row">
                                <div class="col-md-6 col-sm-12">
                                    <div class="video embed-responsive embed-responsive-4by3">
                                        <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/GnJCOof2HJk" allowfullscreen></iframe>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="about-us-desc">
                                        <p>
                                            My name is David Foale. I trade financial instruments for a living; mostly equities, indexes and currencies.
                                        </p>
                                        <p>
                                            This website <i><a href="http://www.davidfoale.info">(I make websites and Apps too,)</a><i> brings together, my trading blog, and some trading interviews I have given, which have been published as trading guides.
                                        </p>
					<script src="//platform.linkedin.com/in.js" type="text/javascript"></script>
					<script type="IN/MemberProfile" data-id="https://www.linkedin.com/in/davidfoale" data-format="inline" data-related="false"></script>
                    <p><a href="https://twitter.com/TheNextMoveIs" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @TheNextMoveIs</a> <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script></p>
                ...
                <div class="clearfix">
                    <h2 class="small-heading">FUN FACTS</h2>
                    <div class="row">
                                ...
                                <div class="services col-md-4  col-xs-12">
                                    <div class="facts">
                                        <div class="facts-overlay">
                                            ...
                                            <p class="count">100000</p>
                                            <p class="text-capitalize">trades</p>
                                        </div>
                                ...
                                <div class="services col-md-4  col-xs-12">
                                    <div class="facts">
                                        <div class="facts-overlay">
                                            ...
                                            <p class="count">6</p>
                                            <p class="text-capitalize">Trading Guides</p>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 col-xs-12">
                                    <div class="team-member-box center-block text-center">
                                        ...
                                        <h4 class="text-capitalize">David Foale</h4>
                            ...
                            <div class="project-container">
                                <div class="row">
                                    <div class="project-controls">
                                        ...
                                        <button class="filter" data-filter=".graphic-design">Index Trading</button>
                                        <button class="filter" data-filter=".web-design">Currencies</button>
                                        <button class="filter" data-filter=".app-development">Trading Guides</button>
                                    </div>
                                    ...
                                    <div id="projects" class="projet-items clearfix">
                                        ...
                                        <div class="pop-up-box" id="portfolio-1">
                                            ...
                                            <div class="popup-content">
                                                <h3>INDEX TRADING</h3>
                                                <p>
                                                    Well we have had the immediate Brexit sell off in equity market, followed by the relief rally / short squeeze. Now one week later my more considered approach is to be SHORT UKX (opened at 6575) and SHORT the UK250 (opened at 16237)
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-2">
                                            ...
                                            <div class="popup-content">
                                                ...
                                                <p>
                                                    The obvious one is sell into any strength of GBP/USD 1:33-1:34 if it gets there, down to 1:25. Next weeks forecast reduction in UK interest rates likely to see this sooner than later. don't forget your stop.
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-3">
                                            ...
                                            <div class="popup-content">
                                               <h3>15 SECRETS from a PROFESSIONAL TRADER</h3>
                                                <p>
                                                    What professional traders know when they make trades, that you may not be aware off. It's the seemingly small details that often make the winning difference between profitable traders and the majority. "If you are not frequently closing out small losers in the short term you probably wont be a winner in the long term."
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-4">
                                            ...
                                            <div class="popup-content">
                                                <h3>INDEX TRADING</h3>
                                                <p>
                                                    We have had the immediate Brexit sell off in equity markets, followed by a strong relief rally / short squeeze. Do not expect this to continue. I am adding incremental short entries in both UKX and UK250 and sharting this week 11/07/16 the DAX.
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-6">
                                            ...
                                            <div class="popup-content">
                                                <h3>A DAY TRADERS DAY</h3>
                                                <p>
                                                    Metrics that matter, opportunities and breakouts. Day trading examples and tactics. Premarket preparation, market open, late morning trades, the US Open, Trading psychology. Cash management and managing account drawdowns.
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="pop-up-box" id="portfolio-9">
                                            ...
                                            <div class="popup-content">
                                                <h3>Commodity Trading Tips for 2016</h3>
                                                <p>
                                                    With the huge volatility witnessed in Commodity markets over the last three years and more recently with the crude oil price, this brochure explains the commodity market in a straight forward need to know manner, focusing on current trading opportunities.
                                                </p>
                                                <a href="#">PREVIEW</a>
                                            </div>
                                        </div>
                                         <!-- Single Portfolio Item [ END ] -->
                                          ...
                                          <div class="clearfix full-height">
                    <h2 class="small-heading">Trading Guide CLIENTS </h2>
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                            <div id="sponsor-list" class="owl-carousel owl-theme">

                                <div class="item">
                                    <img src="assets/img/dianomi.png" alt="sponsor1" class="center-block" style="width: 165px; height: 127px;">
                                </div>
                            <!-- 
                               <div class="item">
                                    <img src="assets/img/sponsor1.png" alt="sponsor2" class="center-block" style="width: 165px; height: 127px;">
                                </div> -->
    ...
    <div id="service" class="service-page container-fluid page">
        <div class="row">
            ...
            <div class="content-container col-md-9 col-sm-12">
                ...
                <div class="clearfix">
                    <h2 class="small-heading">- SUN July 10th - </h2>
                    <div class="row">
                                    ...
                                    <div class="faq-desc-item">
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <h5>Article 50</h5>
                                                   <p>At some point MPs have to trigger Article 50 following a debate and vote in Parliament. Teresa May is ruling out an early election and instead seems to be focusing on curbing immigration as priority number one as she clearly wants to demonstrate a Brexiter can be a serious contender to lead the country out of Europe.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    ...
                                                    <h5>9 Month View</h5>
                                                     <p>Indexes to begin slow but sustained sell off, back towards and then past post EU Referendum lows. Continued volatility in Sterling towards $1:20 by Christmas with more volatility in the EUR/USD than we have seen so far since the Referendum </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                <div class="front">
                                                    ...
                                                    <h5>Political Predictions</h5>
                                                </div>
                                                <div class="back">
                                                    <!-- <i class="fa fa-paint-brush fa-fw"></i> -->
                                                    <h5>Political Predictions</h5>
                                                    <p>By 2017 we may well have the CONSERVATIVES lead by Teresa May, taking us out of Europe. LABOUR led by a bolstered Mr Corbyn with 65% of the LABOUR Membership, a renamed UKIP+ lead by Andrea Leadsom, if she loses to Teresa May and which become the 'Brexit NOW Party' and assorted Reminers/Lib.Dems/Greens in a new DEMOCRAT party lead by Nicki Morgan.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="faq-desc-item">
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <h5>DAX and the FTSE</h5>
                                                   <p>One week after the EU referendum, I am now short both the FTSE100 and the FTSE250 and currently in a losing position, but still looking to add on further strength </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <!-- <i class="fa fa-lightbulb-o fa-fw"></i> -->
                                                    <h5>SILVER </h5>
                                                     <p> Huge speculative rise in this metal particularly since the Referendum. Watching closely, no position, but when I do it will be to the short side.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="flip-container text-center" ontouchstart="this.classList.toggle('hover');">
                                            <div class="flipper">
                                                ...
                                                <div class="back">
                                                    <!-- <i class="fa fa-paint-brush fa-fw"></i> -->
                                                    <h5>Negotiation Skills</h5>
                                                    <p>Renegotiate our relationship with our EU neighbours. Trouble is there is little evidence that UK polititians or Govt. bodies can negotiate themselves out of a paper bag. To negotiate successfully you either have to start from a position of strength, or offer something the other party badly wants while standing your ground on the big things.</p>
...
<!--
        ...
        <!--                
                <div class="clearfix full-height">
                    <h2 class="small-heading">CLIENTS</h2>
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                            <div id="sponsor-list" class="owl-carousel owl-theme">
    ...
    <div id="contact" class="contact-page container-fluid page">
        <div class="row">
            ...
            <div class="content-container col-md-9 col-sm-12">
                ...
                <div class="clearfix full-height">
                    <h2 class="small-heading">FIND me at..</h2>
                    <div class="row">
                        <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
